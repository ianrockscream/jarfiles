...
INPUT_FILTER_RULES = (sys.argv[9])
print(INPUT_FILTER_RULES)
...
def filter_rows(filter_rules='1 = 0', temp_view_input='temp_view_table', temp_view_output='temp_view_table', spark_session=scSpark):
...
temp_view_next = filter_rows(filter_rules=FILTER_RULES, 
